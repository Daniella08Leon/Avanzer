<!--Inicio modal editar--> 
        <div class="modal fade" id="ModalEditarPerfil{{$result->idUsuario}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="/editar/perfil/instructor/{{$result->idUsuario}}/{{$result->idFicha}}" method="post">
                            @csrf 
